...
export default function Tv() {
  ...
  {
    let {data} = await axios.get(`https://api.themoviedb.org/3/trending/tv/week?api_key=bd7de1002d5d536889f2190d815dc7ec&language=en-US&page=${currentPage}`)
  ...
  <h1 className="fw-bolder text-center  py-2 pb-5">Trending Tv</h1>
