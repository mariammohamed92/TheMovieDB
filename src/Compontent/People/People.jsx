...
export default function People() {
  ...
  {
    let {data} = await axios.get(`https://api.themoviedb.org/3/trending/person/week?api_key=bd7de1002d5d536889f2190d815dc7ec&language=en-US&page=${currentPage}`)
...
<div className="row py-5 my-5 align-items-center">
  <h1 className="fw-bolder text-center  py-2 pb-5">Trending People</h1>
